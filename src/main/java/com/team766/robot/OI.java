...
/* 
	...
	public OI() {
		...
		j1 = RobotProvider.instance.getJoystick(0);
	...
	public void run(Context context) {
		context.takeOwnership(Robot.JT);
		context.takeOwnership(Robot.drive);

		
		Robot.JT.swerveCalculate();
		if(j1.getButton(1)){
			Robot.drive.drive2D(Robot.JT.getXSpeed(), Robot.JT.getYSpeed());
		}
